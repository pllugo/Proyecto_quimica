...
def potencial_ozono(condicion_a, numero_enlaces, peso_molecular, numero_carbonos, koh_compuesto, ko3_compuesto, koh_producto, rendimiento_molar, condicion_p, condicion_ro3, condicion_q, region):
    ...
    if koh_producto != 0 and koh_producto <2E-12:
...
#Función para calcular el tiempo de residencia atmosferico de un COV
def tiempo_residencia(constante_cinetica, tipo_radical):
    if constante_cinetica != 0:
        if tipo_radical == "OH":                       
